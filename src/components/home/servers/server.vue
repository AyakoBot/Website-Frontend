...
<template>
 ...
 >
  <div class="relative flex p-5 w-48 h-28 justify-between items-center rounded-2xl shadow-main">
   <img
    v-if="props.banner"
    :src="props.banner"
   ...
   <div class="flex flex-col min-w-[80%] gap-2 ml-3 pr-3">
    ...
    >
     <img src="https://cdn.discordapp.com/emojis/1073254214995816489.webp" class="w-4" />
     {{ props.membercount }}
    </div>
   </div>
  </div>
